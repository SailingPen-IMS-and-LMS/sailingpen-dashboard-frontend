  ...
  <div class="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center">
    <div class="bg-white p-4 rounded-lg shadow-md;">
      <form class="flex flex-col">
        <h1 class="py-4 font-semibold">Add new Blog Post</h1>
        <input v-model="blogName" type="text" placeholder="Blog name" class="mb-4 p-2 border border-gray-300 rounded-md w-100 h-10" />
        <input v-model="className" type="text" placeholder="Class name" class="mb-4 p-2 border border-gray-300 rounded-md w-100 h-10" />
        <input v-model="date" type="date" class="mb-4 p-2 border border-gray-300 rounded-md w-100 h-10" />
        <textarea v-model="postBody" placeholder="Post body" class="mb-4 p-2 border border-gray-300 rounded-md w-100 h-50"></textarea>
        <div class="justify-center flex p-4">
          <button @click="onSubmit" class="px-6 py-1 bg-[#5e5cba] text-white rounded-md cursor-pointer">Post</button>
        </div>
      </form>
    </div>
  </div>
