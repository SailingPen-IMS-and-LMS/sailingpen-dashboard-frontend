  ...
  <div class="staffs-page">
    ...
    <DataTable class="mt-8">
      <template #table-heading-rows>
        ...
        <DataTableHeading>Contact No</DataTableHeading>
      ...
      <template #table-body-rows>
        <DataTableRow v-for="staff in staffs " :key="staff.id">
          <DataTableData>
            <div class="flex items-center gap-4 text-right">
              <img :src="staff.image" alt="" class="h-[40px] w-[40px] rounded-full">
              {{ staff.name }}
            </div>
          </DataTableData>
          <DataTableData>
