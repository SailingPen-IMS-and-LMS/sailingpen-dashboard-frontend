  ...
  <div class="default-layout">
    ...
    <main class="default-page-container flex">
      <div class="mx-auto max-w-2xl px-6 py-10 sm:px-6 sm:py-6 lg:max-w-7xl lg:px-8">
        ...
        <h1 class="text-3xl font-bold mt-0 mb-8">Staff Members</h1>
        <div>
          <table class="table-auto border-2 p-4 m-4 w-[100%] ">
            ...
            <tbody>
              <tr class="bg-white">
                <td class="px-6 py-2 text-center">Kasun Perera</td>
                <td class="px-6 py-2 text-center">2020-04-15</td>
                <td class="px-6 py-2 text-center">Manager</td>
              ...
              <tr class="bg-white">
                <td class="px-6 py-2 text-center">Praveen Kumarage</td>
                <td class="px-6 py-2 text-center">2020-08-20</td>
                <td class="px-6 py-2 text-center">Assistant</td>
                <td class="px-6 py-2 flex justify-center">
                  <div class="flex gap-3">
                    <NButton class="shadow-sm" mode="text" color="success">View</NButton>
                    <NButton class="shadow-sm" mode="text" color="primary">Edit</NButton>
              ...
              <tr class="bg-white">
                <td class="px-6 py-2 text-center">Piyath Rajapaksha</td>
                <td class="px-6 py-2 text-center">2021-12-08</td>
                <td class="px-6 py-2 text-center">Care Taker</td>
                <td class="px-6 py-2 flex justify-center">
                  <div class="flex gap-3">
                    <NButton class="shadow-sm" mode="text" color="success">View</NButton>
                    <NButton class="shadow-sm" mode="text" color="primary">Edit</NButton>
              ...
              <tr class="bg-white">
                <td class="px-6 py-2 text-center">Sakunthala Dias</td>
                <td class="px-6 py-2 text-center">2022-01-18</td>
                <td class="px-6 py-2 text-center">Security</td>
                <td class="px-6 py-2 flex justify-center">
                  <div class="flex gap-3">
                    <NButton class="shadow-sm" mode="text" color="success">View</NButton>
                    <NButton class="shadow-sm" mode="text" color="primary">Edit</NButton>
              ...
              <tr class="bg-white">
                <td class="px-6 py-2 text-center">Mahinda pathirana</td>
                <td class="px-6 py-2 text-center">2022-01-18</td>
                <td class="px-6 py-2 text-center">Security</td>
                <td class="px-6 py-2 flex justify-center">
                  <div class="flex gap-3">
